...
async function loadPost() {
    ...
    if(api.getLoggedInUser() === post.username)
    {
        ...
        btn.onclick = (e) => {
            window.location = convertRelativePath('../edit-post/edit-post.html?id='+post.id);
        }
    }
    ...
    profileLink.href = convertRelativePath('../profile/profile.html?username='+post.username);
